...
<html lang="en">
  <head>
    ...
    <title>Riddims - Reggae Fresh</title>
  ...
  <body>
    ...
    <section class="main-content">
      <div class="section">
        ...
        <?php
          for ( $i = 0; $i < count($riddim); $i ++ )
          {
            echo '
          <a href="" class="post">
            <span class="category">Artists</span>
            <img
            src="'.$riddim[$i]['thumbnail_path'] .'" alt="'.$riddim[$i]['thumbnail_alt'] .'"
            />
            <span class="overlay"
              ><span title="Title" class="title">'.$riddim[$i]['title'] .'</span></span
            >
          </a>
            ';
          }
